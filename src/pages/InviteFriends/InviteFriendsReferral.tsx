  ...
  return (
    <div className="flex relative h-full flex-col justify-center items-center py-4">
      ...
      <button
        ...
        className="bg-white text-black text-base font-[600] w-full py-3 tracking-normal rounded-lg"
      >
        Invite friends
      </button>
      ...
      {openReferral && (
        <div
          className={`popup w-[110%] z-20 -mb-[106px] absolute bottom-0 bg-[#1C1C1E] pb-8 px-5 rounded-tl-xl rounded-tr-xl`}
        >
